...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{paper_plot_knowledge_gain.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{paper_plot_reward_convergence.png}}
\caption{Cumulative Reward Convergence comparing RL and Baseline agents.}
\label{fig2}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{paper_plot_training_overlay.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{paper_plot_per_topic_mastery.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{paper_plot_ablation.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{paper_plot_sensitivity.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{human_study_results.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{paper_plot_cross_dataset.png}}
...
The source code, simulation environment, trained model checkpoints, and datasets used for this study are publicly available at: \textbf{https://github.com/suvomx1999/AI-Tutor.git}. The repository includes scripts to reproduce all figures, the OULAD-calibrated student simulator, and the full protocol for the synthetic user trial.

\section*{Ethical Approval and Informed Consent}
This study utilizes synthetic data generated from statistically calibrated student models, whose parameters were derived from anonymized public datasets such as OULAD. No identifiable human data were collected or processed by the authors, and no direct interaction with human participants took place; therefore, formal institutional review board (IRB) approval and written informed consent from participants were not required. The original data providers obtained consent and ensured anonymization in accordance with their institutional and legal guidelines. The simulation parameters were designed to represent a diverse range of learning speeds and engagement patterns while avoiding overfitting to any single learner profile.

\section*{Competing Interests}
The authors declare that they have no competing interests.

\section*{Authors' Contribution Statement}
Shubashis Mete conceived the study, led the hybrid architecture design, implemented the reinforcement learning agents and Delta-Reward formulation, conducted the main experiments, and drafted the manuscript. Adwait Devadas K. assisted in system design, implemented components of the simulation environment and semantic NLP engine, supported experiment execution and results analysis, and contributed to manuscript writing and revision. R Kingsly Stephen supervised the work, provided pedagogical guidance, advised on study design and interpretation of results, and contributed to critical revision of the manuscript. All authors approved the final version.

\section*{Acknowledgment}
The authors would like to thank the open-source community, specifically the developers of the \texttt{sentence-transformers} library, PyTorch, and Gymnasium.
